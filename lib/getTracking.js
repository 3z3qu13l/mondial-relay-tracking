...
const cleanHistory = (history) => {
    return history
        .map(({datetime, text, location}) => ({datetime, text, location}))
 ...
 * @returns {Array.<{trackingId: String, currentStatus: String, duration: Number, isComplete: Boolean, lastDate: Date, startDate: Date, history: Array}>}
 */
